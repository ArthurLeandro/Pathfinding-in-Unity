...
public class MapData : MonoBehaviour
{
	...
	[SerializeField] Color32 goalColor = new Color32(0, 255, 0, 255);
	[SerializeField] Color32 startColor = new Color32(255, 0, 0, 255);
	...
	void Awake()
	{
		this.textureMap = MapDataStore.textureMapGloball;
	...
	public void SetupLookupTable()
	{
		...
		terrainLookupTable.Add(goalColor, NodeType.GOAL);
		terrainLookupTable.Add(startColor, NodeType.START);
	}
	#endregion
	#region Functions
